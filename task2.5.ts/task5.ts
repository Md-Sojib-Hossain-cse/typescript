/*
Task 5: Generic Constraints MEDIUM Concepts: Generics, Extends Constraint 
...
console.log(logLength("abul"));
console.log(logLength([1, 2, 4]));
console.log(logLength({ length: 2 }));
